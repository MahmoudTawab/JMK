...
open class FPNTextField: UITextField {
    ...
    @objc open var flagButtonSize: CGSize = CGSize(width: ControlWidth(26), height: ControlWidth(26)) {
        didSet {
            layoutIfNeeded()
        }
    }
    ...
    var bottomLineLayer = UIView()
    private func setup() {
        leftViewMode = .always
        
        self.textColor = #colorLiteral(red: 0.3867337108, green: 0.3412475586, blue: 0.3196612, alpha: 1)
        ...
        self.font = UIFont(name: "Raleway-Regular", size: ControlWidth(16))
        phoneCodeTextField.font = UIFont(name: "Raleway-Bold", size: ControlWidth(16))
...
//        }
        ...
        title.text = NSLocalizedString("Phone numbe", comment: "")
        title.textColor = UIColor(red: 99/255, green: 87/255, blue: 82/255, alpha: 1)
        title.font = UIFont(name: "Raleway-Bold", size: ControlWidth(13))
        ...
        PhoneLabel.text = NSLocalizedString("The phone number should begin with 01", comment: "")
        PhoneLabel.translatesAutoresizingMaskIntoConstraints = false
        PhoneLabel.font = UIFont(name: "Raleway-Regular", size: ControlWidth(12))
