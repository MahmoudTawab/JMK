...
class MyPlacesCell: UITableViewCell {
    ...
    var PaymentSettingsWidth1:NSLayoutConstraint?
    var PaymentSettingsWidth2:NSLayoutConstraint?
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        PaymentSettingsWidth1 = PaymentSettings.widthAnchor.constraint(equalToConstant: ControlWidth(45))
        PaymentSettingsWidth1?.isActive = true
        
        PaymentSettingsWidth2 = PaymentSettings.widthAnchor.constraint(equalToConstant: 0)
        PaymentSettingsWidth2?.isActive = false
        ...
        BackgroundView.bottomAnchor.constraint(equalTo: bottomAnchor , constant: ControlY(-15)).isActive = true
