...
protocol CustomizeEventDelegate {
    func ActionBackground(Cell:CustomizeEventCell)
}

class CustomizeEventCell: UICollectionViewCell {

    var Delegate : CustomizeEventDelegate?
