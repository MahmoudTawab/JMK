...
open class GrowingTextView: UITextView {
    ...
    override open func draw(_ rect: CGRect) {
        ...
        self.clipsToBounds = true
        self.textContainerInset = UIEdgeInsets(top: minHeight - ControlHeight(25), left: -4, bottom: 0, right: 0)
        if text.isEmpty {
            let xValue = textContainerInset.left + textContainer.lineFragmentPadding 
            let width = rect.size.width - xValue - textContainerInset.right
            let placeholderRect = CGRect(x: xValue, y: minHeight - ControlHeight(25), width: width, height: minHeight - ControlHeight(25))
    ...
    View.show(from: CGRect(x: self.bounds.size.width / 2, y: ControlY(15), width: ControlWidth(100), height: ControlHeight(25)), inContainerView: self)
    ...
    lazy var View : SHAutocorrectSuggestionView = {
        let View = SHAutocorrectSuggestionView(frame: CGRect(x: self.bounds.size.width / 2, y: ControlY(15), width: ControlWidth(100), height: ControlHeight(25)))
